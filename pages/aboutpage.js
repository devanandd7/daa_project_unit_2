    ...
    <>
      ...
      <div className="p-6 sm:p-8">
        ...
        <p className="text-gray-300 mb-4">
          🎧 Listen to the overview of the 0/1 Knapsack problem while you read!
        </p>

        <audio
          controls
          preload="auto"
          className="fixed bottom-0 left-0 w-full bg-purple-700 p-4 shadow-md"
        >
          <source src="/knapsack.wav" type="audio/wav" />
